...
export default function StatusChip({ status, className = "" }: { status: SubStatus; className?: string }) {
  return (
    <span className={`inline-flex items-center gap-1.5 eyebrow text-[10px] tracking-[0.16em] whitespace-nowrap ${className}`}>
