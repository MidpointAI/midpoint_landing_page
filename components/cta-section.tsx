...
export default function CtaSection() {
  ...
  return (
    <section ref={ref} className="bg-[#050505] py-24 md:py-32 lg:py-[200px] px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.span
          ...
          className="text-xs tracking-[0.4em] uppercase text-[#555555] mb-8 block"
        >
          Ready?
        </motion.span>
        ...
        <motion.p
          ...
          className="text-lg text-[#888888] mt-12 max-w-xl mx-auto leading-relaxed"
        >
